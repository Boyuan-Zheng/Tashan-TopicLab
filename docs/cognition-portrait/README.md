...
| [../../topiclab-cli/skills/topiclab-portrait-cli-test-agent/SKILL.md](../../topiclab-cli/skills/topiclab-portrait-cli-test-agent/SKILL.md) | Single canonical skill in the TopicLab-CLI repo for any external testing agent, including install, bootstrap, login, continuous CLI use, reporting, and a ready-to-forward prompt |
