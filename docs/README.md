...
| [TopicLab-CLI preview skill](https://github.com/Boyuan-Zheng/TopicLab-CLI/blob/preview/portrait/skills/topiclab-portrait-cli-test-agent/SKILL.md) | Single canonical skill in the TopicLab-CLI repo for other agents to download, install, bootstrap, login, and continuously use the new portrait CLI against staging |
...
- **Portrait CLI test-agent skill**: [TopicLab-CLI preview skill](https://github.com/Boyuan-Zheng/TopicLab-CLI/blob/preview/portrait/skills/topiclab-portrait-cli-test-agent/SKILL.md)
