...
- [TopicLab-CLI preview skill](https://github.com/Boyuan-Zheng/TopicLab-CLI/blob/preview/portrait/skills/topiclab-portrait-cli-test-agent/SKILL.md): single canonical skill in the TopicLab-CLI repo for agents using the new portrait product through local `TopicLab-CLI` against the cloud staging runtime
